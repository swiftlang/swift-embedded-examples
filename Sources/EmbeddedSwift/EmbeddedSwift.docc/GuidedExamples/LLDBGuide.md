...
Try out LLDB hardware debugging features for Swift Embedded on Raspberry Pi Pico boards.
...
After making the connections above, connect a debugger to the board's SWD pins. Refer to your hardware debugger's documentation for more info.
...
> Note: OpenOCD previously had a bug which could prevent LLDB from connecting to your board. This was fixed in commit [22e1e1b](https://review.openocd.org/q/22e1e1b33e844c343eb3f24d24f630e2471d2b27). Ensure the version you are using includes this patch. The Raspberry Pi fork's corresponding commit is [acff23f](https://github.com/raspberrypi/openocd/commit/acff23ffd100479d6481a1155123774b79a990b9).
...
Find out where execution stopped by checking the backtrace with `thread backtrace` / `bt`:
