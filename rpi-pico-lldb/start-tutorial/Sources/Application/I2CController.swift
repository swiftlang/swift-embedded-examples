...
class I2CController {
  ...
  convenience init(i2c0SclPin: UInt32, i2c0SdaPin: UInt32) {
    self.init(
      i2c0SclPin: i2c0SclPin, i2c0SdaPin: i2c0SdaPin, address: 0x42,
      enableInternalPullUp: false)
  }

  init(
    i2c0SclPin: UInt32, i2c0SdaPin: UInt32, address: UInt32,
    enableInternalPullUp: Bool
  ) {
    configureI2CPin(i2c0SdaPin, enableInternalPullUp: enableInternalPullUp)
    configureI2CPin(i2c0SclPin, enableInternalPullUp: enableInternalPullUp)
    enableI2C()
  }
